...
class DiffusionTrainingModule(torch.nn.Module):
    ...
    def split_pipeline_units(
        ...
        loss_required_params=(
            "input_latents", "max_timestep_boundary", "min_timestep_boundary",
            "first_frame_latents", "video_latents", "audio_input_latents",
            "num_inference_steps", "sample_num_frames",
            "sample_duration_seconds", "audio_num_samples", "audio_sample_rate",
        ),
